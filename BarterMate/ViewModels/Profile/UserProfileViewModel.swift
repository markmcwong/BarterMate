...
//    
//    var userService: AmplifyGenericModelService<User>
//    var itemService: AmplifyGenericModelService<Item>
//    
//    init(manager: ServiceManager = AppServiceManager.shared) {
//        self.userService = AmplifyGenericModelService<User>()
//        self.itemService = AmplifyGenericModelService<Item>()
...
//                guard GlobalState.shared.userId != nil else {
//                    return
//                }
//                // TODO: user = try await userService.query(Query())
//            } catch {
